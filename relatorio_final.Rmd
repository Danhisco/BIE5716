...
<p> Outra evidência que mostra que os cenários de assimetria competitiva foram extremos é a aproximação da intervalo de confiança inferior do tempo de extinção médio da invasora na presença da residente com o intervalo de confiança superior na ausência da residente (Figura 3). Me pergunto o quanto é necessário reduzir o coeficiente de competição interespecífica da invasora para que o tempo de extinção médio estimado seja indistinguível na presença ou ausência da residente. Porém,o tempo de extinção médio parece não ser uma boa 



A descrição do tempo médio usando um GLM Gamma log não foi uma boa aproximação. A distribuição Gamma pode ser interpretada mecanisticamente como a distribuição de tempos para que um determinado número de eventos em um processo Poisson, em que as probabilidade de um evento ocorrer são constantes

, pois mecanisticamente ela descreve o tempo de espera até que um certo número de eventos ocorra em um processo Poisson

</p>
# efeito do tamanho populacional: pq só quando o tamanho 
<p>
</p>
#
