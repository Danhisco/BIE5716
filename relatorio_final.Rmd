...
l_p[[1]] <- df_plot |> 
  ...
  labs(y="Tempo Extinção (anos)",x="Tamanho inicial invasora", title = "a) Tempo para Ext da inv. na presença da residente e as predições") +
...
l_p[[2]] <- df_plot |> 
  ...
  labs(x="Tempo de Extinção",title = "b) Distr. de Tempos para Extinsão da invasora") +
