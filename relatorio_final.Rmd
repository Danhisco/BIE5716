...
```
```{r análise dos dados da pasta single_species,echo=FALSE}
# df <- df_sim[1,]
...
### GLM Binomial: probabilidade de substituição da residente pela invasora
...
__tabela seleção de GLMs Binomiais para descrever a probabilidade de substituição__
